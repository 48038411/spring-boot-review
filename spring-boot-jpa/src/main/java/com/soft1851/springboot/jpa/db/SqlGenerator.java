package com.soft1851.springboot.jpa.db;
...
public class SqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String packageName = "E:\\dev\\spring-boot-review (2)\\spring-boot-review\\spring-boot-jpa\\src\\main\\java\\com\\soft1851\\springboot\\jpa\\model\\cascade";
        //生成sql的文件夹
